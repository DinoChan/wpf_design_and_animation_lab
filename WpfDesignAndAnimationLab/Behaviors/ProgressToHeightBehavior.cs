...
namespace WpfDesignAndAnimationLab.Behaviors
{
    public class ProgressToHeightBehavior : Behavior<FrameworkElement>
    {
        ...
        public static readonly DependencyProperty BasedElementProperty =
            DependencyProperty.Register(nameof(BasedElement), typeof(FrameworkElement),
                typeof(ProgressToHeightBehavior),
                new PropertyMetadata(default(FrameworkElement), OnBasedElementChanged));

        /// <summary>
        ///     标识 Progress 依赖属性。
        /// </summary>
        public static readonly DependencyProperty ProgressProperty =
            DependencyProperty.Register(nameof(Progress), typeof(double), typeof(ProgressToHeightBehavior),
        ...
        protected virtual void OnProgressChanged(double oldValue, double newValue) => ChangeAssociatedObjectHeight();
