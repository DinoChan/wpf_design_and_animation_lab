...
namespace WpfDesignAndAnimationLab.Behaviors
{
    public class ClipBehavior : Behavior<FrameworkElement>
    {
        ...
        public static readonly DependencyProperty ClipOuterProperty =
            DependencyProperty.Register(nameof(ClipOuter), typeof(bool), typeof(ClipBehavior),
                new PropertyMetadata(default(bool), OnClipOuterChanged));

        /// <summary>
        ///     标识 CornerRadius 依赖属性。
        /// </summary>
        public static readonly DependencyProperty CornerRadiusProperty =
            DependencyProperty.Register(nameof(CornerRadius), typeof(CornerRadius), typeof(ClipBehavior),
        ...
        public static readonly DependencyProperty HeightProperty =
            DependencyProperty.Register(nameof(Height), typeof(double), typeof(ClipBehavior),
                new PropertyMetadata(default(double), OnHeightChanged));

        /// <summary>
        ///     标识 Width 依赖属性。
        /// </summary>
        public static readonly DependencyProperty WidthProperty =
            DependencyProperty.Register(nameof(Width), typeof(double), typeof(ClipBehavior),
                new PropertyMetadata(default(double), OnWidthChanged));
        ...
        protected virtual void OnClipOuterChanged(bool oldValue, bool newValue) => Clip();
        ...
        protected virtual void OnCornerRadiusChanged(CornerRadius oldValue, CornerRadius newValue) => Clip();
        ...
        protected virtual void OnHeightChanged(double oldValue, double newValue) => Clip();
        ...
        protected virtual void OnWidthChanged(double oldValue, double newValue) => Clip();
        ...
        private void Clip()
        {
            ...
            figure.Segments.Add(CreateArcSegment(new Point(Width - CornerRadius.BottomRight, Height),
                CornerRadius.BottomRight));
            figure.Segments.Add(new LineSegment { Point = new Point(CornerRadius.BottomLeft, Height) });
            figure.Segments.Add(CreateArcSegment(new Point(0, Height - CornerRadius.BottomLeft),
            ...
            if (ClipOuter)
            {
                AssociatedObject.Clip = new CombinedGeometry(GeometryCombineMode.Xor, pathGeometry,
                    new RectangleGeometry(new Rect(-5000, -5000, 10000, 10000)));
            }
            else
            {
