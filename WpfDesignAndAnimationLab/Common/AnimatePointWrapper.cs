...
namespace WpfDesignAndAnimationLab.Common
{
    public class AnimatePointWrapper : FrameworkElement
    {
        ...
        public static readonly DependencyProperty AnimationProperty =
            DependencyProperty.Register(nameof(Animation), typeof(PointAnimation), typeof(AnimatePointWrapper),
                new PropertyMetadata(default(PointAnimation), OnAnimationChanged));

        /// <summary>
        ///     标识 Current 依赖属性。
        /// </summary>
        public static readonly DependencyProperty CurrentProperty =
            DependencyProperty.Register(nameof(Current), typeof(Point), typeof(AnimatePointWrapper),
                new PropertyMetadata(default(Point), OnCurrentChanged));

        /// <summary>
        ///     标识 MultipleX 依赖属性。
        /// </summary>
        public static readonly DependencyProperty MultipleXProperty =
            DependencyProperty.Register(nameof(MultipleX), typeof(double), typeof(AnimatePointWrapper),
                new PropertyMetadata(1d, OnMultipleXChanged));

        /// <summary>
        ///     标识 MultipleY 依赖属性。
        /// </summary>
        public static readonly DependencyProperty MultipleYProperty =
            DependencyProperty.Register(nameof(MultipleY), typeof(double), typeof(AnimatePointWrapper),
                new PropertyMetadata(1d, OnMultipleYChanged));

        /// <summary>
        ///     标识 TargetX 依赖属性。
        /// </summary>
        public static readonly DependencyProperty TargetXProperty =
            DependencyProperty.Register(nameof(TargetX), typeof(double), typeof(AnimatePointWrapper),
                new PropertyMetadata(default(double), OnTargetXChanged));

        /// <summary>
        ///     标识 TargetY 依赖属性。
        /// </summary>
        public static readonly DependencyProperty TargetYProperty =
            DependencyProperty.Register(nameof(TargetY), typeof(double), typeof(AnimatePointWrapper),
                new PropertyMetadata(default(double), OnTargetYChanged));

        private PointAnimation _coreAnimation;

        private readonly Storyboard _storyboard = new();

        public AnimatePointWrapper() => Loaded += OnLoaded;
        ...
        protected virtual void OnTargetXChanged(double oldValue, double newValue) => OnTargetChanged();
        ...
        protected virtual void OnTargetYChanged(double oldValue, double newValue) => OnTargetChanged();
