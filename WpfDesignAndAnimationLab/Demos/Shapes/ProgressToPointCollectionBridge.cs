...
namespace WpfDesignAndAnimationLab.Demos.Shapes
{
    ...
    {
        public ProgressToPointCollectionBridge() => Children = new ObservableCollection<PointCollection>();
        ...
        {
            get => (Collection<PointCollection>)GetValue(ChildrenProperty);
        ...
        protected virtual void OnChildrenChanged(Collection<PointCollection> oldValue,
            Collection<PointCollection> newValue)
        {
        ...
        protected virtual void OnProgressChanged(double oldValue, double newValue) => UpdatePoints();

        private static PointCollection GetCurrentPoints(PointCollection fromPoints, PointCollection toPoints,
            double percentage)
        {
        ...
        private void OnChildrenCollectionChanged(object sender, NotifyCollectionChangedEventArgs e) => UpdatePoints();
        ...
        public static readonly DependencyProperty ChildrenProperty =
            DependencyProperty.Register("Children", typeof(Collection<PointCollection>),
                typeof(ProgressToPointCollectionBridge), new PropertyMetadata(null, OnChildrenChanged));

        /// <summary>
        ///     标识 Points 依赖属性。
        /// </summary>
        public static readonly DependencyProperty PointsProperty =
            DependencyProperty.Register("Points", typeof(PointCollection), typeof(ProgressToPointCollectionBridge),
        ...
        public static readonly DependencyProperty ProgressProperty =
            DependencyProperty.Register("Progress", typeof(double), typeof(ProgressToPointCollectionBridge),
