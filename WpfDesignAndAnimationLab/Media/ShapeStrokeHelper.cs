...
namespace WpfDesignAndAnimationLab.Media
{
    public class ShapeStrokeHelper : DependencyObject
    {
        ...
        public static readonly DependencyProperty AttachedShapeProperty =
            DependencyProperty.Register(nameof(AttachedShape), typeof(DependencyObject), typeof(ShapeStrokeHelper),
                new PropertyMetadata(default(DependencyObject), OnAttachedShapeChanged));
